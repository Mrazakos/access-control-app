...
export const LockManagementExample = () => {
  ...
  const {
    // Signature revocation from credentials hook
    revokeSignatureOnChain,
    isTransactionPending: isCredentialTransactionPending,
    transactionHash: credentialTransactionHash,
    transactionError: credentialTransactionError,
